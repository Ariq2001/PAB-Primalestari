...
$pdf->Cell(0,7,'DATA PIUTANG',0,1,'C');
...
$pdf->Cell(30,6,'Jumlah Piutang',1,0,'C');
...
$hasil = mysqli_query($kon, "select * from tb_piutang order by namaplgn");
while ($data = mysqli_fetch_array($hasil)){

    
    $pdf->Cell(8,6,$no,1,0);
    $pdf->Cell(10,6,$data['namaplgn'],1,0);
    $pdf->Cell(15,6,$data['alamat'],1,0);
    $pdf->Cell(15,6,$data['jmltagihan'],1,0);
    $pdf->Cell(20,6,$data['jmlpembayaran'],1,0);
    $pdf->Cell(15,6,$data['jmlpiutang'],1,0);
